<template>
    <div class="dialog-main">
            <div class="layer">
                <span class="layer-title">用户使用协议</span>
                <span class="layer-close" @click="close">X</span>
            </div>
            ...
            <div @click="close" class="confirm">确定</div>
    </div>
</template>
<script>
    export default {
