...
export default {
    ...
    methods: {
        forget() {
            this.$router.push('/tzj/authorized?pop=paw')
        },
        passwordDisplay() {
        ...
        initAjax() {
            let _this = this
            _this.$http.post(global.tzjAjaxUrl+"/tzjapi/bindUser", { userName: _this.mobilePhone, password: _this.ruleForm.pass }).then((res) => {
...
#authorized {
    ...
    .login {
        ...
        position: absolute;
        z-index: 2001;
        background: url(https://aliyunsso.edspay.com/web/tzj/login.png);
        background-size: 100% 100%;
        top: 20%;
        left: 62%;
        .el-form {
