<!-- 西海海域 -->
<template>
    <div id="westSea" class="activitySea">
    	...
    	<div ref="seaBox" class="seaBox">
            <div class="lock">
                <div v-if="userData.sailSum >= 30000" @click="deblocking" class="lockImg"></div>
                <div v-else class="lockImg grey"></div>
            </div>
            <div v-for="item in 150" :ref="'islet'+ (301 - item)" class="islet" :class="{greyIslet: userData.sailSum < (301-item)*100,'islet300':item == 1}">
                <div v-if="userData.sailSum >= (301-item)*100" class="tips">{{item == 1 ? '西海海皇':(301-item +'00m')}}</div>
                <div v-else class="grey-tips tips">{{item == 1 ? '西海海皇':(301-item +'00m')}}</div>
            </div>
        ...
        <find-boss v-if="showLayer.findBoss" :showLayer="showLayer" :lastLand="seaData.lastLand" :redSize="seaData.redSize" :type="3"></find-boss>
        <!-- 出现生物弹框 -->
...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            setTimeout(() =>{
                this.isLetSize.height = this.$refs['islet'+(151)][0].clientHeight;
                this.isLetSize.width = this.$refs['islet'+(151)][0].clientWidth;
...
<style lang="scss" scoped>
    .activitySea{
        ...
        .seaLogo{
            ...
            height: 1.6rem;
            width: 2.24rem;
            background: url('https://aliyunsso.edspay.com/web/wx/vip/treasure2/seaLogo3.png') no-repeat;
        ...
        .unlock{
            ...
            z-index:999;
            background:#fff;
            background: #fff url('https://aliyunsso.edspay.com/web/wx/vip/treasure2/findNorthSea.png') no-repeat;
            background-size:100%;
            padding-top: 7.6rem;
            .lockBox{
                height:3.946667rem;
        ...
        .seaBox{
            background:url('https://aliyunsso.edspay.com/web/wx/vip/vipActivity/westSeaBG.png');
            background-size:100% 100%;
            width: 100%;
            background-size:100%;
            ...
            .islet{
                height:2.666667rem;
                width:3.813333rem;
                background:url('https://aliyunsso.edspay.com/web/wx/vip/vipActivity/westSea/islet.png') no-repeat;
                background-size:100% 100%;
            ...
            .greyIslet{
                background: url(https://aliyunsso.edspay.com/web/wx/vip/treasure2/westLet.png) no-repeat;
                background-size: 100% 100%;
            }
            .islet300{
                height:5.333333rem;
                width:5.333333rem;
                background:url('https://aliyunsso.edspay.com/web/wx/vip/vipActivity/westBoss.gif') no-repeat;
                background-size:100% 100%;
                .tips{
                    height:0.746667rem;
                    width:1.413333rem;
