...
<script>
	...
	export default{
		...
		methods:{
			...
			toInvest(){
				this.toApp('WIP_'+this.borrow.uuid,{ path: '/wxDetail', query: {uuid:this.borrow.uuid}},1)
			}
		},
		components:{
			wxHeader,
...
<style lang="scss" scoped>
	#newPeople{
		.main{
			height: 53.28rem;
			padding-top:17.6rem;
			background:url(https://aliyunsso.edspay.com/web/wx/activity/newPeople/newPeople_1.png) no-repeat;
			background-size:100%;
			.getRed{
