...
<script>
    ...
    export default{
    	...
    	mounted(){
			...
			//id值--openParam、link值--openlinkUr
   			var ios_schema = "edspay://edspay?Id="+ this.$route.query.openParam +"&link=" + global.host + this.$route.query.openlinkUr,
				ios_download_url = global.host + this.$route.query.openlinkUr;
			var android_schema = "edspay://edspay?Id="+ this.$route.query.openParam +"&link=" + global.host + this.$route.query.openlinkUr,
				android_download_url = global.host + this.$route.query.openlinkUr;
