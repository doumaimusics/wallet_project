...
<template>
	<div id="inviteRegister">
		...
		<invite-register :channel="'yaoqing'" :toLink="'/happySummer/happyInviteResult'" :inviterId="inviterId" :gouLists="gouList"></invite-register>
	</div>
</template>
...
<script>
	...
	export default{
		...
		mounted() {
			...
			script.src = 'https://s13.cnzz.com/z_stat.php?id=1274311390&web_id=1274311390'
...
<style lang="scss">
	#inviteRegister{
		background: url('https://aliyunsso.edspay.com/web/wx/activity/happySummer/happyInvite.png') no-repeat;
		background-size: 100%;
		height: 51.466667rem;
		.haoyouphone{
			height:25.8rem;
