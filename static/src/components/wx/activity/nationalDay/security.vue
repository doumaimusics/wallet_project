<template>
    <div id="dationalDay">
        ...
        <div class="earnings">
            ...
            <div @click="appRouter('/channels/xcp')" class="invite li"></div>
        </div>
        <div class="run clear">
...
<script>
    ...
    export default{
    	...
    	data(){
    		return{
                ...
                shareObj: { //分享标题内容配置
                    ...
                    desc: "放心吧，有我在", //内容
                    link: global.host + "activity/securityPublicity", //链接
    	...
    	methods:{
    		...
    		setImageBlessing(e){ //上传合照
				...
				lrz(files[0], { width: 480 }).then((rst) => {
				    this.getAppData('/activity/two/saveUserPicturePathTwo',(data) =>{
				      if(data.resCode){
    	...
    	created(){
    		this.getNumData();
            this._getActivityTime('con_publicity_activity');
    	},
        mounted(){
...
<style lang="scss" scoped>
    #dationalDay{
        background:url('https://aliyunsso.edspay.com/web/wx/activity/security/securityBG.png');
        background-size: 100%;
        height:37.653333rem;
        .showShare{
        ...
        .rultBox{
            ...
            .content{
                ...
                width:8.56rem;
                margin-left:0.45rem;
                background: url('https://aliyunsso.edspay.com/web/wx/activity/security/rult.png') no-repeat;
