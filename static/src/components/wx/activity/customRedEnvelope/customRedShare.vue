<template>
	<div id="customRed">
		<!--title-->
		<wx-header v-if="!osType" :logo="'自定义红包'"></wx-header>
		<div class="main">
			<!--显示数字区域-->
			...
			<div class="rule_box">
				...
				<p><i>2.</i>用户根据自己的出借需要，选择“出借金额”和“项目期限”，点击生成按钮，系统会自动生成适用的红包，用户可点击领取；</p>
		...
		methods: {
			...
			getRed() { //红包状态
						...
						setTimeout(function() {
								...
								let texts = '<span style="color:#333;">恭喜您成功生成' + money + '元出借红包。</span><br/><span style="color:#F95E3F;font-size:14px;">红包领取后，使用掉才能领取下一个！</span>'
