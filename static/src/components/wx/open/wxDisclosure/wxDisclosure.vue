<template>
	<div id="tabTemplateBox">
		...
		<div class="tabContent">
			...
			<tabTemplate5 :type="10" v-else-if="num==4"></tabTemplate5>						
		</div>
...
<script>
	...
	import tabTemplate1 from './corporate.vue'   //  法人承诺函
	import tabTemplate2 from './approve.vue'   //  备案信息
	import tabTemplate3 from './organization.vue'   //  组织信息
	import tabTemplate4 from './auditing.vue'   //  审核信息
	import tabTemplate5 from './commonProblem.vue'   //  经营信息

	export default {
		mixins: [wxToapp],
		data() {  
			return {
				titleList: ['法人承诺函', '备案信息', '组织信息','审核信息','经营信息'],      // 标题内容
				num: 0,
				swiperOption: {
